...
namespace PrisonStep
{
    public class AnimatedModel
    {
        ...
        BoundingCylindar boundingCylinder;
        ...
        public int GetIndexOfBone(string name)
        {
            return model.Bones[name].Index;
        }
        ...
        public Matrix GetBoneAbsoluteTransform(int index)
        {
            Matrix transform = model.Bones[index].Transform;
            //Console.WriteLine(transform);
           return absoTransforms[index];
            //return transform;
        ...
        {
            boundingCylinder = new BoundingCylindar();
            boundingCylinder.CalculateBoundingBox(model,Matrix.Identity);  
        ...
        private void DrawModel(GraphicsDeviceManager graphics, Model model, Matrix world)
        {
            ...
            foreach (ModelMesh mesh in model.Meshes)
            {
                foreach (Effect effect in mesh.Effects)
                {
                    ...
                    effect.Parameters["Light4Location"].SetValue(game.LightInfo(game.Player.CurrentSectionNumber, 4));
                    if(skelToBone != null)
        ...
        public Matrix[] AbsoTransforms
        {
            get { return absoTransforms; }
            set { absoTransforms = value; }
        }
        public Matrix[] BonesTransforms
        {
            get { return bonesTransforms; }
            set { bonesTransforms = value; }
        }
        public Matrix[] BindTransforms
        {
            get { return bindTransforms; }
