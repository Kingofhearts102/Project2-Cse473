        ...
        private void DrawModel(GraphicsDeviceManager graphics, Model model, Matrix world)
        {
            ...
            foreach (ModelMesh mesh in model.Meshes)
            {
                foreach (Effect effect in mesh.Effects)
                {
                    ...
                    effect.Parameters["Light3Location"].SetValue(game.LightInfo(game.Player.CurrentSectionNumber, 4));
                    effect.Parameters["Light3Color"].SetValue(game.LightInfo(game.Player.CurrentSectionNumber, 5));
                    effect.Parameters["Light4Location"].SetValue(game.LightInfo(game.Player.CurrentSectionNumber+1, 0));
                    effect.Parameters["Light4Color"].SetValue(game.LightInfo(game.Player.CurrentSectionNumber+1, 1));
